<x-jet-form-section submit="updateFortifySettings">
    ...
    <x-slot name="title">
        {{ __('settings.auth.title') }}
    </x-slot>

    <x-slot name="description">
        {{ __('settings.auth.description') }}
    </x-slot>
    ...
    <x-slot name="form">
        @canany(['view', 'update'], [\App\Settings\FortifySettings::class, 'registration_enabled'])
            ...
            <div class="col-span-6 sm:col-span-4">
                <x-jet-label for="registration_enabled" value="{{ __('settings.auth.users-registration-enabled') }}" />
        ...
        @canany(['view', 'update'], [\App\Settings\FortifySettings::class, 'password_resets_enabled'])
            ...
            <div class="col-span-6 sm:col-span-4">
                <x-jet-label for="password_resets_enabled" value="{{ __('settings.auth.passwords-resets-enabled') }}" />
        ...
        @canany(['view', 'update'], [\App\Settings\FortifySettings::class, 'update_passwords_enabled'])
            ...
            <div class="col-span-6 sm:col-span-4">
                <x-jet-label for="update_passwords_enabled" value="{{ __('settings.auth.passwords-updating-enabled') }}" />
        ...
        @canany(['view', 'update'], [\App\Settings\FortifySettings::class, 'update_profile_enabled'])
            ...
            <div class="col-span-6 sm:col-span-4">
                <x-jet-label for="update_profile_enabled" value="{{ __('settings.auth.profile-updating-enabled') }}" />
        ...
        @canany(['view', 'update'], [\App\Settings\FortifySettings::class, 'two_factor_authentication_enabled'])
            <!-- 2FA Enabled -->
            <div class="col-span-6 sm:col-span-4">
                <x-jet-label for="two_factor_authentication_enabled" value="{{ __('settings.auth.2fa-enabled') }}" />
