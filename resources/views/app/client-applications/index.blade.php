                                ...
                                <div class="-mt-px flex divide-x divide-gray-200">
                                    @can('view', $app)
                                        <div class="flex w-0 flex-1">
                                            <a href="{{ route('web-print.printers.show', $app) }}" class="relative -mr-px inline-flex w-0 flex-1 items-center justify-center rounded-bl-lg border border-transparent py-4 text-sm font-medium text-gray-700 hover:text-gray-500">
                                    ...
                                    @can('viewAny', [\App\Models\PrintJob::class])
                                        <div class="-ml-px flex w-0 flex-1">
                                            <a href="{{ route('web-print.jobs.index', ['app' => $app]) }}" class="relative inline-flex w-0 flex-1 items-center justify-center rounded-br-lg border border-transparent py-4 text-sm font-medium text-gray-700 hover:text-gray-500">
                                                ...
                                                <span class="ml-3">Jobs ({{ $app->jobs_count }})</span>
                                            </a>
                                        </div>
                                    @endcan
                                </div>
            ...
            @else
                @can('create', \App\Models\ClientApplication::class)
                    <a href="{{ route('web-print.apps.create') }}" class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                        ...
                        <span class="mt-2 block text-sm font-medium text-gray-900">Create a new client application</span>
                    </a>
                @else
                    <div class="text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No client applications</h3>
                        <p class="mt-1 text-sm text-gray-500">You don't have permission to create new client applications.</p>
                        {{--                <div class="mt-6">--}}
